...
public class MerchandiseQueryRepositoryImpl implements MerchandiseQueryRepository {
    ...
    @Override
    public PaginationQueryResult<Merchandise> findWishlistOrderByWishDate(Long id, Pageable page) {
        List<Merchandise> merchandiseList = queryFactory
                .select(merchandise)
                .from(wish)
        ...
        return new PaginationQueryResult<>(merchandiseList, (int) totalPage);
    }

    @Override
    public PaginationQueryResult<Merchandise> findRegisteredMerchandiseOrderByCreatedAt(Long id, Pageable page) {
        List<Merchandise> merchandiseList = queryFactory
                .select(merchandise)
                .from(user)
