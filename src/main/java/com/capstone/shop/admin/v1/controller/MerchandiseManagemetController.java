...
import com.capstone.shop.user.v1.service.UserWebMerchandiseServiceImpl;
...
public class MerchandiseManagemetController {
    ...
    public ResponseEntity<ApiResponse> updateMerchandise(@RequestBody MerchandiseUpdateResponseDto merchandiseUpdateResponseDto, @PathVariable Long id) {
        ApiResponse response = userMerchandiseService.updateMerchandise(merchandiseUpdateResponseDto, id);
